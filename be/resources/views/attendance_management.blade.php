                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        <input type="text" id="search"
                            ...
                            placeholder="Tìm kiếm chấm công...">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $attendance_shifts->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $attendance_overtimes->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $attendance_shifts->where('status', 'present')->count() + $attendance_overtimes->where('status', 'present')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600">Đi muộn</p>
                            <p class="text-2xl font-bold text-gray-900">{{ $attendance_shifts->where('status', 'late')->count() + $attendance_overtimes->where('status', 'late')->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="border-b border-gray-200">
                    <nav class="flex space-x-8 px-6" aria-label="Tabs">
                        ...
                        >
                            ...
                            <span>Tăng Ca</span>
                            <span class="bg-purple-100 text-purple-600 px-2 py-1 rounded-full text-xs font-medium">{{ $attendance_overtimes->count() }}</span>
                        </button>
                    </nav>
                </div>
