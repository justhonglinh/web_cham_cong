                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <div class="flex items-center justify-center space-x-2">
                                                ...
                                                <form action="/shift/management/{{ $shift->id }}" method="POST" class="inline-block" onsubmit="return confirm('Bạn có chắc muốn xóa ca làm này không?');">
                                                    ...
                                                    <button type="submit" 
                                                        class="inline-flex items-center px-3 py-2 {{ $shift->attendances()->exists() ? 'bg-gray-400 cursor-not-allowed' : 'bg-red-600 hover:bg-red-500' }} text-white rounded-full transition duration-200" 
