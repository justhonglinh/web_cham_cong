<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Bảng chấm công -->
            <div id="attendance-table" class="block bg-white dark:bg-gray-800 shadow-lg sm:rounded-lg overflow-hidden transition-all duration-500 mb-10">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 px-6 pt-6 pb-2">Bảng chấm công</h3>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class='px-6 py-4 whitespace-nowrap'>
                                                <img src="{{ $att->user->avatar ? asset('storage/' . $att->user->avatar) : 'https://via.placeholder.com/40' }} alt="Avatar" class="w-12 h-12 rounded-full object-cover">
                                            </div>
                                            <div class="ml-4">
    ...
    <script>
    // Tìm kiếm nhân viên cho cả hai bảng
...
@php
// Lọc dữ liệu $attendance_shifts theo shift_id (ví dụ: chỉ lấy shift_id = 1)
$filtered_attendance_shifts = $attendance_shifts->filter(function($att) {
    return $att->shift_id == 1; // Thay 1 bằng shift_id bạn muốn lọc
});
@endphp
