                ...
                submitBtn.addEventListener('click', async function(e) {
                    ...
                    try {
                        ...
                        if (result.success) {
                            ...
                            alert('Không nhận diện được khuôn mặt phù hợp: ' + (result.message || 'Vui lòng thử lại.'));
                            submitBtn.disabled = false;
                            submitBtn.innerHTML = `<span class='font-semibold'>📸 Chụp ảnh & Chấm công</span>`;
                        }
                    } catch (error) {
                        alert('Lỗi kết nối server khi so sánh khuôn mặt. Vui lòng thử lại.');
                        submitBtn.disabled = false;
                        submitBtn.innerHTML = `<span class='font-semibold'>📸 Chụp ảnh & Chấm công</span>`;
                    }
                });
